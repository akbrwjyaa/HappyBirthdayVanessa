...
const defaultHeartImages = Array.from({ length: 95 }, (_, i) => `images/img${i + 1}.jpg`);
...
const ringTexts = [
  ...
  "Vanessa Salsabila",//untuk deskripsi planet layer 2
  "♡Happy Birthday♡",//untuk deskripsi planet layer 3
  "16/03/2005",//untuk deskripsi planet layer 4
